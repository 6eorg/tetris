...
public class Trapez extends Piece {
    ...
    public void initialize() {
        ...
        //minus values //todo evtl. diese nehmen. schauen, was besser
//        shape1.add(new Point(4, -1));
//        shape1.add(new Point(3, 0));
//        shape1.add( new Point(4, 01));
//        shape1.add( new Point(5, 0));
//        shapes.add(shape1);
//
//        ArrayList<Point> shape2 = new ArrayList();
//        shape2.add(new Point(4, -1));
//        shape2.add(new Point(4, 0));
//        shape2.add( new Point(5, 0));
//        shape2.add( new Point(4, 1));
//        shapes.add(shape2);
//
//        ArrayList<Point> shape3 = new ArrayList();
